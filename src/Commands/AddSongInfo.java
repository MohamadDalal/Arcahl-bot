...
public class AddSongInfo implements ICommand{
    @Override
    ...
    public String getDescription() {
        return "Adds a song to the song info table. (Owner only command)";
    }

    @Override
    public List<OptionData> getOptions() {
        List<OptionData> optionsList = new ArrayList<>();
        optionsList.add(new OptionData(OptionType.STRING, "name", "The name of the song to add to the info table.", true));
        return optionsList;
    }
