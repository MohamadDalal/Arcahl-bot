...
public class FillSongList implements ICommand{
    @Override
    ...
    public String getDescription() {
        return "Fills the database with the song info of new songs. (Owner only command)";
    }
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        if(event.getUser().getId().equals("310153696044515349")){
            ...
            String reply = DatabaseAPI.fillSongInfo();
